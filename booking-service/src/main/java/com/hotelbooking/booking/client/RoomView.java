 ...
 * Duplicating this small record is what lets each service be built, versioned and
 * deployed on its own.
 *
 * <p>{@code ignoreUnknown = true} matters — room-service can add fields without
 * breaking deserialization here, so the two can be released independently.
 */
